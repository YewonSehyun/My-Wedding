...
const CONFIG = {
  ...
  greeting: {
    title: "소중한 분들을 초대합니다",
    content: "가장 사랑하는 사람과 \n가장 평범한 하루를 보내고 싶어요.\n-영화 <윌터의 상상은 현실이 된다>중에서\n\n이 평범하고도 벅찬 소망을 함께 이룰\n소중한 사람을 만났습니다.\n\n 언제나 가장 나다운 모습으로 기댈 수 있는\n곁이 되어주며 평생을 나란히 걷겠습니다.\n\n저희의 첫 걸음을 함께 축복해 주시면 감사하겠습니다."
  },

  // ── 우리의 이야기 ──
  story: {
    title: "그렇게 우리는",
    content: "세월 속에서 자연스럽게 가까워졌고,\n현실의 시간 속에서 서로를 닮아가며,\n\n예전보다 더 편안한 사이가 되어,\n원래부터 함께였던 것처럼 살아가려 합니다."
  },
...
meta: {
  title: "이세현 ♥ 김예원 결혼합니다",
  description: "2026년 8월 23일 오후 12시, 잠실 더베네치아에서 소중한 분들을 초대합니다."
}
};
